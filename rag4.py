...
"若申报产品未在境外上市，需如何提供证明文件？",
"如何推断‘免于临床评价’产品的资料要求？",
"若产品含纳米材料，需额外提供哪些研究？",
"如何确定‘使用者灭菌’产品的验证内容？",
"若软件安全性级别为‘轻微’，研究资料可否简化？",
"如何分析不良事件发生率的数据意义？",
"若产品与药物联合使用，需优先验证什么？",
"如何判断是否需要动物试验？",
"若产品为可重复使用，需提供哪些证据？",
"如何选择‘同品种临床评价’或‘临床试验’路径？",

"若产品无灭菌要求，是否需提交‘灭菌研究’？",
"若产品无软件组件，是否需提供‘软件研究’？",
"若申报产品为首次上市，如何填写‘不良事件和召回’？",
"若产品适用范围不涉及儿童，是否需说明？",
"若产品无需包装（如大型设备），是否需提供‘包装说明’？",
"若产品为无源医疗器械，是否需提供‘电气安全性研究’？",
"若产品未采用国际标准，是否需说明理由？",
"若产品无生物材料，是否需提交‘生物源材料安全性研究’？",
"若产品为一次性使用，是否需证明无法重复使用？",
"若未与监管机构沟通，是否需提交‘申报前沟通记录’？",
...
"是否所有原材料均需提供来源证明？"
    ...
    test_results.to_excel("测试结果.xlsx", index=False)
